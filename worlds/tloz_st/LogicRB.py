...
def make_overworld_logic(player: int, origin_name: str, world):
    ...
    overworld_logic = [
        ...
        ["wt 1f north", "wt 1f key", False, has_whirlwind | has_boomerang],
        ["wt 1f north", "wt 1f", False, None],

        ["wt 1f", "wt 1f left", True, has_small_keys("Wooded Temple", 1, event="_wt_key")],
        ...
        ["wt 2f left", "wt 2f moth", False, has_small_keys("Wooded Temple", 2, event="_wt_key")],
        ["wt 2f moth", "wt 2f left", False, can_kill_moth & has_small_keys("Wooded Temple", 2, event="_wt_key")],
