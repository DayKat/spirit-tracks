...
- You can hit the left arrow repeater on SW 20F from the switch top left (doesn't affect logic)
  ...
  - you can jump on the pushable block in that room to reach it with whip (Hard logic)
  - you can have zelda push you on the block to hit it with sword (Hard Logic)
