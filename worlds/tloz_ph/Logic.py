...
def make_overworld_logic():
    overworld_logic = [
        ...
        ["Ghost Ship 1F", "NW Ocean", False, None],
        ...
        ["Ruins SW Maze Lower Water", "Ruins NW Maze Lower Water", True, False],  # Separate the water logic from the transition
        ...
        ["Ruins NW Cave", "Grassy Treasure Cave", True, None],
        ...
        ["Ruins NW Lower Water", "Ruins NE Lower Water North", True, None],
        ...
        ["Ruins NE Lower Water South", "Ruins NW Alcove Water", True, None],
        ...
        ["Ruins NE Lower Water Bay", "Ruins SE Lower Water Bay", True, None],
            ["Ruins NE Lower Water Bay", "Ruins NE Lower", True, "ruins_water"],
            ["Ruins SE Lower Water Bay", "Ruins SE Lower", True, "ruins_water"],
        ["Ruins NE Behind Pyramids Water", "Ruins SE Coast Water", True, False],
        ...
        ["Ruins SE Lower Water Wall", "Ruins NE Secret Chest Water", True, None],
        ...
        ["Ruins SE King's Road Water", "Ruins NE Geozards Water", True, False],
