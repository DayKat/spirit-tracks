...
# ===== Gust =====
    ...
    "Cannon Cave South": {
        "return_name": "Cannon Cave Exit South",
        "entrance_region": "cannon fuzo",
        "exit_region": "cannon eddo",
    ...
    "Cannon Cave North": {
        "return_name": "Cannon Cave Exit North",
        "entrance_region": "cannon fuzo",
        "exit_region": "cannon eddo",
        "entrance": (0x13, 0x0, 0x2),
        "exit": (0x28, 0x0, 0x1),
    ...
    "IotD Tunnel Exit": {
        "return_name": "IotD Face Staircase",
        "entrance_region": "iotd tunnel",
        "exit_region": "iotd face",
        "entrance": (0x15, 0x3, 0x2),
        "exit": (0x15, 0x0, 0x5),
        "type": EntranceGroups.CAVE,
        "direction": EntranceGroups.OUTSIDE,
    },
    ...
    "Molida Geozard Cave": {
        ...
        "entrance_region": "moilda cave post geozard",
    ...
    "Molida Cave Back Cave": {
        ...
        "entrance_region": "moilda cave back",
        "exit_region": "molida cave octos",
    ...
    "Molida Cliff North": {
        ...
        "entrance_region": "moilda cliff south",
        "exit_region": "molida cliff north",
    ...
    "Molida Cave Sun Staircase": {
        ...
        "entrance_region": "moilda cave sun door",
