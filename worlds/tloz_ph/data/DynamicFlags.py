...
DYNAMIC_FLAGS = {
    ...
    "RESET Mercay freedle gift treasure map": {
        ...
        "set_if_true": [(addr_treasure_maps_2, 0x20)]
    },
    "Mercay oshus dig treasure map": {
        "on_scenes": [0xB00],
        "not_has_locations": ["Mercay SW Tree Dig"],
        "unset_if_true": [(addr_treasure_maps_1, 0x10)],
    ...
    "Enter Cannon: Not Bought Cannon": {
        ...
        "unset_if_true": [(addr_adv_flags_6, 0x1), (addr_adv_flags_17, 0x10)]
    },
    "Enter Cannon: Not Bought Salvage": {
        "on_scenes": [0x130B],
        "not_has_locations": ["Eddo's Salvage Arm"],
        "has_locations": ["Eddo's Cannon"],
        "set_if_true": [(addr_adv_flags_6, 0x1)],
        "unset_if_true": [(addr_inventory_6, 0x10), (addr_adv_flags_17, 0x10)]
    },
    "Exit Cannon": {
        "on_scenes": [0x130B],
    ...
    "Exit Cannon: Have Salvage": {
        ...
        "set_if_true": [(addr_inventory_6, 0x10), (addr_adv_flags_17, 0x10)]
    },
    "Exit Cannon: Not Have Cannon": {
        # "on_scenes": [0x1300, 0x130A],
        "has_items": [("Cannon", 0)],
        "unset_if_true": [(addr_adv_flags_6, 0x1)]
    },
    ...
    "Cannon Open Door": {
        "on_scenes": [0x130B],
        "set_if_true": [(addr_adv_flags_6, 0x2)]
    },
    ...
    "RESET Spirit of power 2": {
        ...
        "set_if_true": [(addr_fairies_1, 0x9)]
    },
    ...
    "RESET Courage Crest room not salvaged it": {
        ...
        "has_locations": ["Ocean SW Salvage Courage Crest"],
        "set_if_true": [(addr_adv_flags_2, 0x40)]
    },
    ...
    "Spawn Phantoms in Totok B13": {
        ...
        "set_if_true": [(addr_adv_flags_22, 0x40)],
    ...
    "RESET Spawn Phantoms in Totok B13": {
        # "on_scenes": [0x2600],
        "unset_if_true": [(addr_adv_flags_22, 0x40)]
    },
    "Block Bellum Staircase": {
        "on_scenes": [0x2600],
        "set_if_true": [(addr_adv_flags_25, 0x2)],
        # "reset_flags": ["RESET Block Bellum Staircase"]
    },
    "RESET Block Bellum Staircase": {
        # "on_scenes": [0xB01],
        "unset_if_true": [(addr_adv_flags_25, 0x2)]
    },
    ...
    "Spawn bellum warp": {
        "on_scenes": [0x2600],
        "goal_requirement": True,
        "set_if_true": [(addr_adv_flags_29, 0x4)],
        "has_slot_data": [["bellum_access", 2]],
    ...
    "Spawn phantom wreckage": {
        ...
        "set_if_true": [(addr_adv_flags_31, 0x1)],
        "has_slot_data": [["bellum_access", 3]],
    },
    "Not Triforce Crest Rando": {
        "on_scenes": [0x2507],
        "set_if_true": [(addr_adv_flags_4, 0x2)],
    ...
    "Despawn Linebeck if setting": {
        ...
        "unset_if_true": [(addr_adv_flags_4, 0x4)],
    },
    "reset mercay": {
        "on_scenes": [0xB03],
    ...
    "RESET Despawn Linebeck setting": {
        # "on_scenes": [0xB02],
        "set_if_true": [(addr_adv_flags_2, 0x8)]
    },
    ...
    "Mercay skip blow on map for Linebeck": {
        "on_scenes": [0xB03],
        "unset_if_true": [(addr_adv_flags_1, 0x2)]
    },
    "mercay Safety Shipyard": {
        "on_scenes": [0xB03],
        "has_locations": ["Blaaz Boss Reward"],
        "set_if_true": [(addr_adv_flags_3, 0x20)]
    },
    # Fog
    "No fog add fog if spirits": {
        ...
        "unset_if_true": [(addr_flags_clear_fog, 0x80)],
        "set_if_true": [(addr_flags_fog_done, 0x10)]
    },
    "Remove fog on ghost ship if no fog": {
        "on_scenes": [0x2903],
        "has_slot_data": [("fog_settings", 0)],
        "not_has_locations": ["Ghost Ship Rescue Tetra"],
        "set_if_true": [(addr_flags_clear_fog, 0x80), (addr_flags_fog_done, 0x10)],
    },
    "Spawn Spirits in fog": {
        ...
        "has_items": [("Spirit of Power (Progressive)", 1),
                      ...
                      ("Spirit of Courage (Progressive)", 1)],
        "not_has_locations": ["Ghost Ship Rescue Tetra"],
        "set_if_true": [(addr_flags_fog_spirits, 0x10)],
    },
    "Remove spirit flag on GS": {
        "on_scenes": [0x2903],
        "unset_if_true": [(addr_flags_fog_spirits, 0x10)]
    },
    ...
    "Respawn ghost ship": {
        ...
        "set_if_true": [(addr_flags_fog_spirits, 0x10), (addr_flags_fog_done, 0x10)],  # Spawn spirits, remove fog
        "unset_if_true": [(addr_flags_clear_fog, 0x80)]  # Respawn ghost ship
    },
    ...
    "Spawn ghost ship Open GS removed fog": {
        ...
        "has_locations": ["Ghost Ship Rescue Tetra"],
        "set_if_true": [(addr_flags_fog_spirits, 0x10)],  # Spawn spirits, remove fog
        "unset_if_true": [(addr_flags_clear_fog, 0x80)],  # Respawn ghost ship
    },
    "Spawn ghost ship Open GS": {
        ...
        "has_slot_data": [("fog_settings", 2)],
        "not_has_locations": ["Ghost Ship Rescue Tetra"],
        "set_if_true": [(addr_flags_fog_spirits, 0x10)],  # Spawn spirits,
        "unset_if_true": [(addr_flags_clear_fog, 0x80), (addr_flags_fog_done, 0x10)],  # Respawn ghost ship, add fog
    },
    ...
    "RESET Respawn ghost ship": {
        ...
        "set_if_true": [(addr_flags_clear_fog, 0x80), (addr_flags_fog_spirits, 0x10), (addr_flags_fog_done, 0x10)]
    },
    ...
    "RESET yellow guy fog to settings": {
        # "on_scenes": [0x0],
        "has_slot_data": [("fog_settings", 0)],
        "set_if_true": [(addr_flags_clear_fog, 0x80)]
    },
    ...
    "Beat goron temple goron chief": {
        ...
        "unset_if_true": [(addr_adv_flags_23, 0x2)],
    ...
    "RESET Harrow island Map 4": {
        ...
        "set_if_true": [(addr_treasure_maps_3, 0x4)]
    },
    "RESET Harrow island Map 4 got": {
        # "on_scenes": [0x2],
        "has_items": [("Treasure Map #25 (Dead E)", 0)],
        "unset_if_true": [(addr_treasure_maps_3, 0x4)]
    },
    "Harrow have NE sea chart": {
        "on_scenes": [0x1800],
        "has_items": [("NE Sea Chart", 1)],
        "set_if_true": [(addr_adv_flags_1, 0x10)]
    },
    "Harrow not have NE sea chart": {
        "on_scenes": [0x1800],
        "has_items": [("NE Sea Chart", 0)],
        "unset_if_true": [(addr_adv_flags_1, 0x10)]
    },
    "SE spawn pirate ship": {
        "on_scenes": [0x2, 0x3],
        "not_has_locations": ["Ocean Miniblin Pirate Ambush Item"],
        "has_locations": ["Ghost Ship Rescue Tetra"],
        "set_if_true": [(addr_flags_fog_spirits, 0x10), (addr_flags_clear_fog, 0x80), (addr_flags_fog_done, 0x10)]
    },
    "SE despawn pirate ship": {
        "on_scenes": [0x2, 0x3],
        "not_has_locations": ["Ghost Ship Rescue Tetra"],
        "unset_if_true": [(addr_flags_fog_spirits, 0x10), (addr_flags_clear_fog, 0x80), (addr_flags_fog_done, 0x10)]
    ...
    "Zauz remove phantom blade": {
        ...
        "unset_if_true": [(addr_adv_flags_22, 0x20)],
        "reset_flags": ["RESET Zauz remove phantom blade"]
    },
    "RESET Zauz remove phantom blade": {
        # "on_scenes": [0x1600],
        "has_items": [("Phantom Blade", 1)],
        "set_if_true": [(addr_adv_flags_22, 0x20)]
    },
    "Zauz remove triforce crest": {
        "on_scenes": [0x160A],
        "not_has_locations": ["Ghost Ship Rescue Tetra"],
        "unset_if_true": [(addr_flags_fog_done, 0x10), (addr_adv_flags_4, 2), (addr_flags_clear_fog, 0x80)],
        "reset_flags": ["RESET Zauz remove triforce crest"]
    },
    "Zauz add triforce crest": {
        "on_scenes": [0x160A],
        "has_locations": ["Ghost Ship Rescue Tetra"],
        "set_if_true": [(addr_flags_fog_done, 0x10), (addr_adv_flags_4, 2), (addr_flags_clear_fog, 0x80)],
        "reset_flags": ["RESET add triforce crest"]
    },
    "RESET Zauz remove triforce crest": {
        # "on_scenes": [0x1600],
        "has_items": [("Triforce Crest", 1)],
        "set_if_true": [(addr_adv_flags_4, 2)]
    },
    "RESET add triforce crest": {
        # "on_scenes": [0x1600],
        "has_items": [("Triforce Crest", 0)],
        "unset_if_true": [(addr_adv_flags_4, 2)]
    },
    "RESET Zauz remove triforce crest fog": {
        "on_scenes": [0x1600],
        "has_slot_data": [("fog_settings", 0)],
        "set_if_true": [(addr_flags_fog_done, 0x10), (addr_flags_clear_fog, 0x80)]
    },
    ...
    "Block phantom sword crafting blade": {
        ...
        "unset_if_true": [(addr_adv_flags_22, 0x20), (addr_inventory_5, 0x20)]
    },
    ...
    "RESET Block phantom sword crafting": {
        # "on_scenes": [0xB00],
        "has_items": [("Sword (Progressive)", 2)],
        "set_if_true": [(addr_inventory_5, 0x20)]
    },
    "Oshus not have phantom sword": {
        # "on_scenes": [0xB00],
        "has_items": [("Sword (Progressive)", 2, "not_has")],
        "unset_if_true": [(addr_inventory_5, 0x20)],
    },
    ...
    "Block Oshus Gem": {
        "on_scenes": [0xB0A],
        "not_has_locations": ["Cyclok Boss Reward"],
        "unset_if_true": [(addr_adv_flags_36, 0x4), (addr_adv_flags_1, 0x2)]
    },
    "RESET Block Oshus Gem": {
        # "on_scenes": [0xB00],
        "has_locations": ["TotOK Lobby Phantom Hourglass"],
        "set_if_true": [(addr_adv_flags_36, 0x4)]
    },
    "Oshus Gem": {
        "on_scenes": [0xB0A],
        "not_has_locations": ["Oshus Spirit Gem"],
        "has_locations": ["Cyclok Boss Reward"],
        "set_if_true": [(addr_adv_flags_36, 0x4), (addr_adv_flags_1, 0x2), (addr_adv_flags_3, 0x40)]
    },
    "RESET Oshus Gem hourglass": {
        # "on_scenes": [0xB00],
        "not_has_locations": ["TotOK Lobby Phantom Hourglass"],
        "unset_if_true": [(addr_adv_flags_36, 0x4)]
    },
    "RESET Oshus Gem chart": {
        # "on_scenes": [0xB00],
        "unset_if_true": [(addr_adv_flags_1, 0x2)]
    ...
    "Oshus absent backup gem": {
        ...
        "set_if_true": [(addr_adv_flags_41, 0x2)]
    },
    "Oshus absent backup sword": {
        "on_scenes": [0xB0A],
        "has_items": [("Phantom Hourglass", 1), ("Phantom Blade", 1)],
        "has_locations": ["Blaaz Boss Reward"],
        "set_if_true": [(addr_adv_flags_41, 0x2), (addr_inventory_5, 0x20)]
    },
    # Trade Quest
    "PoRL Trade Quest": {
        "on_scenes": [0x700],
        "not_has_locations": ["Prince of Red Lions Trade Quest Item"],
        "unset_if_true": [(addr_flags_trade_quest, 0x98), (addr_inventory_6, 0x20)],
    ...
    "Nyave Trade Quest": {
        ...
        "unset_if_true": [(addr_flags_trade_quest, 0x80), (addr_inventory_6, 0x20)],
        "reset_flags": ["RESET Swordsmans Scroll", "RESET Wood Heart"]
    },
    "Hoiger Trade Quest": {
        "on_scenes": [0x900],
        "not_has_locations": ["Hoiger Howgendoogen Trade Quest Item"],
        "unset_if_true": [(addr_flags_trade_quest, 0x90), (addr_inventory_6, 0x20)],
    ...
    "Wayfarer Trade Quest": {
        ...
        "unset_if_true": [(addr_inventory_6, 0x20)],
        "reset_flags": ["RESET Swordsmans Scroll"]
    },
    "Wayfarer Hut Trade Quest": {
        "on_scenes": [0x1401],
        "not_has_locations": ["Wayfarer Trade Quest Chest"],
        "unset_if_true": [(addr_flags_trade_quest, 0x80)],
    ...
    "RESET Swordsmans Scroll": {
        ...
        "set_if_true": [(addr_inventory_6, 0x20)]
    },
    "RESET Wood Heart": {
        # "on_scenes": [0x0, 0x1, 0x2, 0x3],
        "has_items": [("Wood Heart", 1)],
        "not_has_locations": ["Wayfarer Trade Quest Chest"],
        "set_if_true": [(addr_flags_trade_quest, 0x80)]
    },
    "RESET Guard Notebook": {
        # "on_scenes": [0x0, 0x1, 0x2, 0x3],
        "has_items": [("Guard Notebook", 1)],
        "not_has_locations": ["Nyave Trade Quest Item"],
        "set_if_true": [(addr_flags_trade_quest, 0x10)]
    },
    "RESET Kaleidoscope": {
        # "on_scenes": [0x1, 0x2, 0x3],
        "has_items": [("Kaleidoscope", 1)],
        "not_has_locations": ["Hoiger Howgendoogen Trade Quest Item"],
        "set_if_true": [(addr_flags_trade_quest, 0x8)]
    },
    # Ghost Ship HC
    "Ghost Ship HC": {
        "on_scenes": [0x3000],
        "not_has_locations": ["Cubus Sisters Heart Container"],
        "unset_if_true": [(addr_flags_fog_done, 0x8)],
        "reset_flags": ["RESET Ghost Ship HC"]
    },
    "RESET Ghost Ship HC": {
        "set_if_true": [(addr_flags_fog_done, 0x8)]
    },
    "Ghost ship spawn warp": {
        "on_scenes": [0x2900],
        "check_bits": [(addr_flags_clear_fog, 0x10)],
        "set_if_true": [(addr_adv_flags_7, 0x40)]
    },
    # Vanilla frogs
    "Frogs show glyph": {
        "on_scenes": [0, 1, 2, 3],
        "has_slot_data": [("randomize_frogs", 0)],
        "set_if_true": [(addr_adv_flags_38, 0x40)]
    },
    "Uncharted unset frog flag": {
        "on_scenes": [0x1a0b, 0x1a00],
        "unset_if_true": [(addr_adv_flags_38, 0x40)]
    },
    # Doyland
    "Doyland lower water": {
        "on_scenes": [0x2201],
        "not_has_locations": ["Doylan's Gift"],
        "unset_if_true": [(addr_adv_flags_6, 0x4), (addr_adv_flags_45, 0x30)],
        "reset_flags": ["RESET Doyland lowered water"]
    },
    "RESET Doyland lowered water": {
        "has_lowered_water": True,
        "set_if_true": [(addr_adv_flags_6, 0x4)],  # Water level
    },
    "Ice Field pre-dungeon": {
        "on_scenes": [0xF03],
        "not_has_locations": ["Gleeok Boss Reward"],
        "unset_if_true": [(addr_flags_metals, 0x20)],
        "reset_flags": ["RESET Ice Field pre-dungeon"]
    },
    ...
    "Ice Field post-dungeon": {
        ...
        "set_if_true": [(addr_flags_metals, 0x20)],
    ...
    "RESET Swordfish Shadow": {
        ...
        "unset_if_true": [(addr_adv_flags_43, 0x10)]
    },
    "Fishing remove Fish": {
        "on_scenes": [0x200],
        "unset_if_true": [(addr_skippyjack_count, 0xFF), (addr_toona_count, 0xFF),
                          (addr_loovar_count, 0xFF), (addr_rsf_count, 0xFF),
                          (addr_neptoona_count, 0xFF), (addr_stowfish_count, 0xFF)],
    ...
    "RESET Salvage has no hitbox until you get cannon...": {
        # "on_scenes": [0, 1, 2, 3, 0xB03],
        "unset_if_true": [(addr_flags_cannon, 1)],
        "has_items": [("Cannon", 0)]
    },
    "RESET Salvage salvage": {
        # "on_scenes": [0xD00],
        "unset_if_true": [(addr_adv_flags_17, 0x10)],
        "not_has_locations": ["Eddo's Salvage Arm"]
    },
    # Man of smiles prize postcard
    "Man of smiles prize postcard removal": {
        "on_scenes": [0x600],
        "unset_if_true": [(addr_adv_flags_19, 0x08)],
    ...
    "Remove big catch lure if no skippyjack": {
        ...
        "unset_if_true": [(addr_inventory_6, 0x80)],
    ...
    "RESET Remove big catch lure if no skippyjack": {
        ...
        "set_if_true": [(addr_inventory_6, 0x80)]
    },
    # Beedle Point Thresholds
    "Beedle points bronze": {
        "on_scenes": [0x500],
        "beedle_points": 1,
        "set_if_true": [(addr_adv_flags_12, 0x40)]
    },
    "Beedle points silver": {
        "on_scenes": [0x500],
        "beedle_points": 20,
        "set_if_true": [(addr_adv_flags_18, 0x20)]
    },
    "Beedle points gold": {
        "on_scenes": [0x500],
        "beedle_points": 50,
        "set_if_true": [(addr_adv_flags_18, 0x40)]
    },
    "Beedle points plat": {
        "on_scenes": [0x500],
        "beedle_points": 100,
        "set_if_true": [(addr_adv_flags_18, 0x80)]
    },
    "Beedle points vip": {
        "on_scenes": [0x500],
        "beedle_points": 200,
        "set_if_true": [(addr_adv_flags_19, 0x1)]
    },
    # Ember Stuff
    "Ember remove double linebeck": {
        "on_scenes": [0xD00],
        "set_if_true": [(addr_flags_bosses_0, 0x20)],
        "reset_flags": ["RESET Ember double linebeck"],
    },
    "RESET Ember double linebeck": {
        "not_has_locations": ["Blaaz Boss Reward"],
        "unset_if_true": [(addr_flags_bosses_0, 0x20)],
    },
    ...
    "Molida respawn crayk": {
        "on_scenes": [0x2C00],
        "not_has_locations": ["Crayk Boss Reward"],
        "unset_if_true": [(addr_flags_bosses_0, 0x80)],
    },
    ...
    "Regal necklace backup removal": {
        ...
        "unset_if_true": [(addr_adv_flags_6, 0x8)]
    },
    # TotOK shortcuts
    "Spawn yellow warp early": {
        ...
        "on_scenes": [0x2600],
        "set_if_true": [(addr_adv_flags_46, 0x20)]
    },
    "TotOK Elevator down": {
        "on_scenes": [0x250D],
        "last_scenes": [0x250C],
        "set_if_true": [(addr_totok_b9_elevator, 0x10)]
    },
    "TotOK Elevator up": {
        "on_scenes": [0x250D],
        "last_scenes": [0x250E],
        "unset_if_true": [(addr_totok_b9_elevator, 0x10)]
    },
    # Map warping setup
    "Reset sea charts": {
        "on_scenes": [0, 1, 2, 3],
    ...
    "RESET Give all sea charts if map warping": {
        ...
        "set_if_true": [(addr_inventory_5, 0x1E)]
    },
    "Map warp remove sw chart": {
        "on_scenes": [0, 1, 2, 3],
        "has_items": [("SW Sea Chart", 0)],
        "unset_if_true": [(addr_inventory_5, 0x2)]
    },
    "Map warp remove nw chart": {
        "on_scenes": [0, 1, 2, 3],
        "has_items": [("NW Sea Chart", 0)],
        "unset_if_true": [(addr_inventory_5, 0x4)]
    },
    "Map warp remove se chart": {
        "on_scenes": [0, 1, 2, 3],
        "has_items": [("SE Sea Chart", 0)],
        "unset_if_true": [(addr_inventory_5, 0x8)]
    },
    "Map warp remove ne chart": {
        "on_scenes": [0, 1, 2, 3],
        "has_items": [("NE Sea Chart", 0)],
        "unset_if_true": [(addr_inventory_5, 0x10)]
    },
}
